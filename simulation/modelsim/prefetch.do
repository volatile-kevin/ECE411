...
add wave -noupdate /mp4_tb/dut/instruction_cache/hit
add wave -noupdate /mp4_tb/dut/instruction_cache/control/state
add wave -noupdate /mp4_tb/dut/instruction_cache/control/next_state
add wave -noupdate -radix hexadecimal /mp4_tb/dut/instruction_cache/pmem_address
add wave -noupdate -radix hexadecimal /mp4_tb/dut/instruction_cache/pmem_address
add wave -noupdate -radix hexadecimal /mp4_tb/dut/instruction_cache/mem_address
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {991034 ps} 0}
...
update
WaveRestoreZoom {975800 ps} {1150056 ps}
